...
// 
  ...
  //   setExpArray(userdata.experience)
  //   }
  // },[])
//
const clearExp = (id)=>{
      ...
      >
        ...
        >
          <div>
            <h3>Experience</h3>
            <ul>
              {userdata.experience?.map((expArray)=>(
                <li key={expArray._id}>{expArray?.exp}  <ClearIcon
                sx={{ cursor:"pointer"}}
                onClick={() => {
                  console.log("ClearIcon  clicked");
                  clearExp(expArray._id)
                }} 
                /></li>
              ))}
              {/* <li>Network Engineer <ClearIcon/></li>
              <li>Network Engineer <ClearIcon/></li>
              <li>Network Engineer <ClearIcon/></li>
              <li>Network Engineer <ClearIcon/></li> */}
            </ul>
